...
describe('foundry mode-entry continuation', () => {
  it('auto-continues from confirm_design into architecture_design synthesis without user input', async () => {
        ...
        expect.arrayContaining([
          expect.objectContaining({
            ...
            result: expect.objectContaining({
              terminal: expect.objectContaining({ name: 'synthesize_program_spec' }),
            }),
          }),
        ]),
      );
